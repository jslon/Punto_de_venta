<html>
  ...
  <body>
	<form action = "FacturaBD.php" method = "post" name = "form">
		...
		<button type="submit" name ="BtnCodBarra" value = "BtnCodBarra">Agregar a Factura</button>
		<br>
		<br>
		...
		<input type="textbox" name="TxtSubTotal" value =<?php echo $subtotal; ?>> 
		<br>
		...
		<label>Total: </label>
		<input type="textbox" name="TxtTotal" value =<?php echo (($subtotal * (13/100)) + $subtotal) ; ?>>
		<br>
		
		<label>Fecha: </label>
		<input type="textbox" name="TxtFecha" value = <?php echo date("Y-m-d");?>>
		<br>
		
		<button type="submit" name ="BtnImprimir" value = "BtnImprimir">Efectuar Pago</button> 
